...
public partial class GameContext {
    ...
    public Assets.ECS.Components.PlayerCameraComponent playerCamera { get { return playerCameraEntity.playerCamera; } }
    ...
    public GameEntity SetPlayerCamera(UnityEngine.Camera newValue) {
        if (hasPlayerCamera) {
            throw new Entitas.EntitasException("Could not set PlayerCamera!\n" + this + " already has an entity with Assets.ECS.Components.PlayerCameraComponent!",
...
public partial class GameEntity {
    ...
    public Assets.ECS.Components.PlayerCameraComponent playerCamera { get { return (Assets.ECS.Components.PlayerCameraComponent)GetComponent(GameComponentsLookup.PlayerCamera); } }
    ...
    public void AddPlayerCamera(UnityEngine.Camera newValue) {
        ...
        var component = (Assets.ECS.Components.PlayerCameraComponent)CreateComponent(index, typeof(Assets.ECS.Components.PlayerCameraComponent));
